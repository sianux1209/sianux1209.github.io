...
> MAC OS가 없을 때, Windows 환경에서 AWS EC2 서비스를 이용해 Flutter로 만든 IoS App을 빌드하는 방법을 소개합니다.
...
> 이 방법은 Windows 환경에서 MAC을 사용하는 방법 중 **문제가 생길 경우 Apple의 지원을 받을 수 있는 유일한 방법**입니다.
